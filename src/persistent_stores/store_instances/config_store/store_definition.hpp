...
#endif
{
    ...
    StoreItem<std::array<char, pl_username_size>, defaults::prusalink_username, journal::hash("PrusaLink Username")> prusalink_username;
    ...
    StoreItem<bool, false, journal::hash("Phase Stepping Enabled X")> phase_stepping_enabled_x;
    StoreItem<bool, false, journal::hash("Phase Stepping Enabled Y")> phase_stepping_enabled_y;
